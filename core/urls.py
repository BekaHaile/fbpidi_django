...
urlpatterns = [
    ...
    path("userprofile/",TemplateView.as_view(template_name="frontpages/profile/userprofile.html"),name="userprofile"),
    path("mylistings/",TemplateView.as_view(template_name="frontpages/profile/mylistings.html"),name="mylistings"),
    path("manged/",TemplateView.as_view(template_name="frontpages/profile/manged.html"),name="manged"),
    path("orders/",TemplateView.as_view(template_name="frontpages/profile/orders.html"),name="orders"),
    path("tips/",TemplateView.as_view(template_name="frontpages/tips.html"),name="tips"),
    path("payments/",TemplateView.as_view(template_name="frontpages/profile/payments.html"),name="payments"),
    path("pricing/",TemplateView.as_view(template_name="frontpages/profile/pricing.html"),name="pricing"),
