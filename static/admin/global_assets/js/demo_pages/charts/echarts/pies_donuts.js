        ...
        if (pie_basic_element) {
            ...
            pie_basic.setOption({
                ...
                legend: {
                    ...
                    top: 'center',
                    left: 0,
                    data: ['Beverages', 'Foods', 'Pharmaceuticals', 'Soft drinks', 'Alchol'],
                    itemHeight: 8,
                    itemWidth: 8
                },
                ...
                series: [{
                    ...
                    data: [
                        {value: 335, name: 'Beverages'},
                        {value: 310, name: 'Foods'},
                        {value: 234, name: 'Pharmaceuticals'},
                        {value: 135, name: 'Soft drinks'},
                        {value: 1548, name: 'Alchol'}
                    ]
                }]
            });
        }
